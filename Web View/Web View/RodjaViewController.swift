...
class RodjaViewController: UIViewController {

    @IBOutlet weak var RodjaWebViewapps: UIWebView!
    
    //deklarasi url web
    let urlWeb = "https://www.radiorodja.com"
    ...
    override func viewDidLoad() {
        ...
        RodjaWebViewapps.loadRequest(request as URLRequest)
    }
