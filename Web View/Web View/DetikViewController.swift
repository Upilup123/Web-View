...
class DetikViewController: UIViewController {

    @IBOutlet weak var DetikWebViewApps: UIWebView!
    
    //deklarasi url web
    let urlWeb = "https://www.detik.com"
    ...
    override func viewDidLoad() {
        ...
        DetikWebViewApps.loadRequest(request as URLRequest)
